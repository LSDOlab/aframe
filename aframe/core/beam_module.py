...
class EBBeam(m3l.ExplicitOperation):
    ...
    def evaluate(self, forces:m3l.Variable=None, moments:m3l.Variable=None) -> m3l.Variable:
        ...
        mass = m3l.Variable(name='mass', shape=(1,), operation=beam_operation)
        cg = m3l.Variable(name='cg_vector', shape=(3,), operation=beam_operation)
        inertia_tensor = m3l.Variable(name='inertia_tensor', shape=(3,3), operation=beam_operation)
