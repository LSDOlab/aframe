...
aluminum = af.IsotropicMaterial(name='aluminum', E=69E9, G=26E9, density=2700, nu=0.33)
...
# displacement
beam_displacement = solution.get_displacement(beam)

# stress
beam_stress = solution.get_stress(beam)
