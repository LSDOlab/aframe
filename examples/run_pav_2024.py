...
aluminum = af.IsotropicMaterial(name='aluminum', E=7.3E10, G=27E9, density=2768)
...
beam.add_boundary_condition(node=10, dof=[1, 1, 1, 1, 1, 1])
beam.add_load(loads)
...
# displacement
displacement = solution.get_displacement(beam)
